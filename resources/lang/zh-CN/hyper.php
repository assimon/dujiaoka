...
return [
    ...
    'buy_promo_code'             => '优惠码',
    'buy_input_promo_code'       => '您有优惠码？',
    'buy_verify_code'            => '验证码',
    'buy_payment_method'         => '支付方式',
    'buy_order_now'              => '提交订单',
    'buy_product_desciption'     => '商品详情',
    'buy_warning'                => '警告！',
    'buy_select_payment_method'  => '请选择支付方式',
    'buy_behavior_verification'  => '行为验证',
    'buy_email_cannot_be_empty'  => '邮箱不能为空！',
    'buy_quantity_cannot_be_z'   => '购买数量不能为 0！',
    'buy_quantity_exceeds_limit' => '数量不允许大于库存！',
    'buy_query_pwd_is_not_empty' => '查询密码不能为空！',
    'buy_no_payment_method'      => '未选择支付方式！',
    'buy_code_is_not_empty'      => '验证码不能为空！',
    ...
    'orderinfo_order_pending'      => '待处理',
    'orderinfo_order_processed'    => '已处理',
    'orderinfo_order_completed'    => '已完成',
    ...
    'searchOrder_search_now'             => '立即查询',
    'searchOrder_reset_order'            => '重置',
    'searchOrder_input_order_num'        => '请输入订单编号',
    'searchOrder_input_email'            => '请输入邮箱',
    'searchOrder_input_query_pwd'        => '请输入查询密码',
];