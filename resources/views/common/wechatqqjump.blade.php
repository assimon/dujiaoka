...
<div class="top-bar-guidance">
    <p>点击右上角<img src="/assets/common/images/3dian.png" class="icon-safari">在 浏览器 打开</p>
    <p>苹果设备<img src="/assets/common/images/iphone.png" class="icon-safari">安卓设备<img src="/assets/common/images/android.png" class="icon-safari">↗↗↗</p>
</div>
