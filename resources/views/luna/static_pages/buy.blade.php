                            ...
                            <div class="goods-msg">
                                <div class="goods-name">
                                    ...
                                    <span>
                                        ...
                                        @if($pd_type == 1)
                                            <span
                                                class="small-tips tips-green">{{ __('system.automatic_delivery') }}</span>
                                        @else
                                            <span class="small-tips tips-yellow">{{ __('system.charge') }}</span>
                                        @endif
                                        <span
                                            class="small-tips tips-blue">{{__('system.in_stock')}}({{ $in_stock }})</span>
                                    </span>
                                </div>
                                <div class="price">
                                ...
                                <div class="entry notSelection">
                                    ...
                                    <label class="input">
                                        ...
                                        <input class="pay-num" name="order_number" id="orderNumber"
                                    ...
                                    <div class="entry code">
                                        ...
                                        <label class="input">
                                            <input type="text"
                                                   ...
                                                   required lay-verify="required"
                                                   placeholder="{{ __('luna.buy_code_tips') }}">
                                        </label>
            ...
            <div class="layui-col-md8 layui-col-md-offset2 layui-col-sm12">
                <div class="main-box">
                    <div class="title" style="border-bottom: 1px solid #f7f7f7;padding-bottom: 5px">
                        ...
                        <span>{{ __('system.product_desciption') }}</span>
                    </div>
                    <div class="intro">
                        {!! $pd_info !!}
                    </div>
