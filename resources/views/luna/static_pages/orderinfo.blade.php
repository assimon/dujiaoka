                            ...
                            <div class="layui-row order-list">
                                ...
                                <div class="layui-col-md4">
                                    <ul class="info-ui">
                                        ...
                                        <li><strong>
                                                {{ __('system.number_of_orders') }}:
                                            </strong>
                                            {{ $order['buy_amount'] }}
                                        </li>
                                        <li><strong>{{ __('system.order_time') }}:</strong> {{ $order['created_at'] }}
                                        </li>
                                        <li><strong>{{ __('luna.email') }}:</strong> {{ $order['account'] }}</li>
                                    </ul>
                                </div>
                                <div class="layui-col-md4">
                                    <ul class="info-ui">
                                        ...
                                        <li><strong>{{ __('luna.order_status') }}:</strong> <!----> <!---->
                                            ...
                                            @switch($order['ord_status'])
                                                ...
                                                <span class="small-tips tips-pink">
                                                    {{ __('system.order_pending') }}
                                                </span>
                                                @break
                                                @case(2)
                                                <span class="small-tips tips-blue">
                                                    {{ __('system.order_processed') }}
                                                </span>
                                                @break
                                                @case(3)
                                                <span class="small-tips tips-green">
                                                    {{ __('system.order_completed') }}
                                                </span>
                                                @break
                                                @case(4)
                                                <span class="small-tips tips-yellow">
                                                    {{ __('system.order_failed') }}
                                                </span>
                                                @break
                                            @endswitch
                                        </li>
                                ...
                                <div class="layui-col-md4">
                                    ...
                                    <div class="btn" style="width: 100%">
                                        <button class="clipboard-but"
                                                ...
                                                type="button" data-clipboard-text="{{ $order['ord_info'] }}">
                                            {{ __('system.order_copy') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
