    ...
    <div class="layui-row">
        <div class="layui-col-md8 layui-col-md-offset2 layui-col-sm12">
            <ul class="layui-nav layui-bg-molv" lay-filter="">
                ...
                <li class="layui-form @if(\Illuminate\Support\Facades\Request::path() != '/') layui-hide @endif" style="position: relative;display: inline-block;*display: inline;*zoom: 1;vertical-align: middle;line-height: 60px;"><input id="Search" type="text" placeholder="搜索商品或分类" value="" class="layui-input" autocomplete="off" ></li>
            </ul>
        </div>
    </div>
