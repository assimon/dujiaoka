            ...
            <div class="layui-card cardcon">
                ...
                <div class="layui-card-body">
                    ...
                    @if(Agent::isMobile() && $jump_payuri)
                        ...
                        <p class="errpanl" style="text-align: center"><a onclick="document.getElementById('btnpay').src = '{{ $jump_payuri }}'" class="layui-btn layui-btn-warm layui-btn-sm">点我打开app支付</a></p>
                    @endif
