                    ...
                    <div class="layui-row">
                        <div class="layui-col-md3 layui-hide-xs">
                            <div class="layui-card">
                                <div class="layui-card-body">
                                    <img
                                        src="{{ \Illuminate\Support\Facades\Storage::disk('admin')->url($pd_picture) }}"
                            ...
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    <form class="layui-form layui-form-pane" action="{{ url('postOrder') }}"
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                @foreach($payways as $way)
                                                    <input type="radio" lay-verify="payway" name="payway"
                                                           value="{{ $way['id'] }}" title="{{ $way['pay_name'] }}">
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                        ...
                                        <div class="layui-form-item">
                                            <div class="layui-input-block">
                                                <button class="layui-btn" lay-submit lay-filter="postOrder">立即下单
                                                </button>
